   ...
   const subscriptionRequest = {
    ...
    params: {
      ...
      tokenList: [
        ...
        {
          exchangeType: 1,
          tokens: ['99926037'],/*we need to send a different array for stocks/insturments of BSE as it is exchange type 3. Below are the different exchangeTypes according to the docs.
          */
        },
      ],
    },
